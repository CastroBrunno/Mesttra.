...
function main() {
    ...
    valorTotalTerreno = calcularValorTotal(areaTerreno, valorMetroQuadrado).toFixed(2)

    console.log(`A área do terreno com frente ${metragemFrente} e lateral ${metragemLateral} é ${areaTerreno}`)    //desafio 1
